      ...
      <nav className="bg-white/90 backdrop-blur-sm shadow-sm hidden md:block sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between h-16">
            <div className="flex">
              <Link to="/" className="flex items-center px-4 text-purple-600 font-semibold">
                <Home className="h-5 w-5 mr-2" />
                Home
              </Link>
              <Link to="/leads" className="flex items-center px-4 text-gray-600 hover:text-purple-600">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-gray-200 md:hidden z-50">
        <div className="grid grid-cols-3 h-16">
          ...
          <Link
            to="/leads"
            className={`flex flex-col items-center justify-center ${
              location.pathname === '/leads' ? 'text-purple-600' : 'text-gray-600'
            }`}
          >
